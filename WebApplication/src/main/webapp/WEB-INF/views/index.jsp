...
<body>
	...
	<c:if test = "${messageSuccessful != null}">
    	<div class="alert alert-success" role="alert">
  			<h3 class="text-center"> ${messageSuccessful} </h3>
		</div>
    </c:if>
			...
			<div class="user_card">
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="http://localhost:<%out.print(porta); out.print(path);%>/signUp" class="ml-2">Sign Up</a>
					</div>
					
					<!-- FORGOT PASSWORD
						<div class="d-flex justify-content-center links">
							<a href="http://localhost:<%out.print(porta); out.print(path);%>/forgotPassword">Forgot your password?</a>
						</div>
					 -->
				</div>
			</div>
